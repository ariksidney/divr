...
const routes: Routes = [
  ...
  { path: 'course/:id', component: DiveCourseComponent, canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin } },
  { path: 'course/:id/:user', component: DiveCourseComponent },
